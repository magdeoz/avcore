...
#i am now back from the dead and i cant remember anything about this code, so i need help from someone who could read and verify it for me. :-(
...
Busybox_Applet_Generator(){
	local n i busyboxloc busyboxenv cmd
	if [[ ! "$(busybox)" ]]; then
