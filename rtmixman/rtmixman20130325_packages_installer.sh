...
sleep 2;
echo "";
echo "now, you will be given a series of questions, its a part of procedure, for complete installation!:)";
sleep 2;
echo "remember to always give careful attention to what you're doing!";
sleep 7;
clear;
sleep 2;
echo "STEP 1:";
...
echo "";
echo "";
echo "-Dalvik Booster Lite V2";
sleep 2;
echo "";
echo "unlike the older versions of Dalvik Booster which caused unintended lags,";
sleep 2;
echo "this version was designed to fix some of the codes to max out the original performance of dalvik vm. no harm can be done:)";
sleep 2;
echo "co-operates with Rapid Storage Boost™ Technology 2.0 Unlocked";
sleep 2;
echo "";
while true;
	do
...
sleep 2;
echo "reminder: 'Unlocked' refers to some features that are modified or deleted to gain full potential of the original engine.";
sleep 2;
echo "";
while true;
	do
...
sleep 2;
echo "some users reported that once this engine starts to kick in, the device spits out a massive gaming performance!";
sleep 2;
echo "";
echo "NOTE: this engine creates a usrsettings file on /system/etc directory.";
sleep 2;
...
================================================<br>
Dalvik Booster Lite V2:<br>
-unlike the older versions of Dalvik Booster which caused unintended lags,<br>
-this version was designed to fix some of the codes to max out the original performance of dalvik vm. no harm can be done:)<br>
-co-operates with Rapid Storage Boost™ Technology 2.0 Unlocked<br>
<br>
...
-reminder: 'Unlocked' refers to some features that are modified or deleted to gain full potential of the original engine.<br>
<br>
...
EOF
cat >> /mnt/sdcard/rtmixtemp3.sh <<EOF
Dalvik Booster Lite V2 installed.<br>
EOF
elif [ $sdvm == 0 ];
	then
cat >> /mnt/sdcard/rtmixtemp3.sh <<EOF
Dalvik Booster Lite V2 not installed.<br>
EOF
fi;
if [ $rsb == 1 ];
	then
...
EOF
cat >> /mnt/sdcard/rtmixtemp3.sh <<EOF
Rapid Storage Boost™ Technology 2.0 Unlocked installed.<br>
EOF
elif [ $rsb == 0 ];
	then
cat >> /mnt/sdcard/rtmixtemp3.sh <<EOF
Rapid Storage Boost™ Technology 2.0 Unlocked not installed.<br>
EOF
fi;
if [ $rtmix == 1 ];
	then
...
sleep 2;
echo "";
echo "are you sure you wish to completely remove it from your device?(y/n):";
read i
case $i in
	y|Y)
	sleep 0;
